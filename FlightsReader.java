...
public class FlightsReader {
	...
	/**
	 * Returns a hash set of flight route details (0: flight route code, 1: airline
	 * code, 2: airport code of departure, 3: departure time GMT, 4: airport code of
	 * arrival, 5: arrival time GMT, 6: route cost)
	 */
